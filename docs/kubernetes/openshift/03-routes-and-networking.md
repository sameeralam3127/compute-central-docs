...
A **Route** is OpenShift's own object for exposing a Service through its built-in HAProxy router. **Ingress** is the Kubernetes standard, and OpenShift creates a Route for each Ingress you apply.
